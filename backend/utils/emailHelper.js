        ...
        const mailOptions = {
            ...
            html: `
                <div style="font-family: 'Segoe UI', Arial, sans-serif; background-color: #f4f6f9; padding: 40px 20px; text-align: center;">
                    <div style="max-width: 550px; background-color: #ffffff; border-radius: 16px; box-shadow: 0 10px 30px rgba(0,0,0,0.05); padding: 40px; margin: 0 auto; border-top: 6px solid #6366f1;">
                        <h1 style="color: #1e1b4b; font-size: 28px; margin-bottom: 20px; font-weight: 700;">Welcome to Pawly!</h1>
                        ...
                        <div style="background: linear-gradient(135deg, #e0e7ff 0%, #c7d2fe 100%); padding: 18px 24px; border-radius: 12px; margin-bottom: 30px; display: inline-block;">
                            <span style="font-size: 36px; font-weight: 800; color: #4338ca; letter-spacing: 6px;">${otp}</span>
                        </div>
